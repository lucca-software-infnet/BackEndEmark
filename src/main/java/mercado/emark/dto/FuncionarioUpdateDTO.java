...
public class FuncionarioUpdateDTO {
    ...
    @Pattern(regexp = "(\\(?\\d{2}\\)?[\\s-]?)?(\\d{4,5}[\\s-]?\\d{4})", 
             message = "Telefone inválido (formatos aceitos: (00) 0000-0000, (00) 00000-0000, 0000-0000)")
    private String telefone;

    @Pattern(regexp = "(\\(?\\d{2}\\)?[\\s-]?)?(\\d{5}[\\s-]?\\d{4})", 
             message = "Celular inválido (formatos aceitos: (00) 00000-0000, 00000-0000)")
    ...
    @NotNull(message = "Campo administrador é obrigatório")
