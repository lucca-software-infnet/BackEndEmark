...
public class ClienteUpdateDTO {
    ...
    @Pattern(regexp = "\\(?\\d{2}\\)?[\\s-]?\\d{4,5}[\\s-]?\\d{4}", message = "Telefone inválido (use (00) 0000-0000 ou (00) 00000-0000)")
    private String telefone;

    @Pattern(regexp = "\\(?\\d{2}\\)?[\\s-]?\\d{5}[\\s-]?\\d{4}", message = "Celular inválido (use (00) 00000-0000)")
